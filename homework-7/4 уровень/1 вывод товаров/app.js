...
let divout = document.querySelector(".products");
...
function showCategory(category) {
  switch (category) {
    case "phones":
      divout.innerHTML = getProductMarkup(products.phones);
      break;
    case "tablets":
      divout.innerHTML = getProductMarkup(products.tablets);
      break;
    case "tv":
      divout.innerHTML = getProductMarkup(products.tv);
      break;
  }
}
